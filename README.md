...
## 이번 업데이트 (v0.1.38) — Agent 프롬프트 히스토리·탭 단축키·파일 생성 흐름 보강

2026년 6월 5일 릴리스는 Agent Panel 입력 경험과 좌우 작업 패널의 단축키 동작을 다듬는 데 초점을 맞췄습니다. 보낸 프롬프트를 방향키로 다시 불러오고, 현재 포커스된 Agent/터미널/문서 탭을 기준으로 닫기·순환·새 터미널 동작이 더 자연스럽게 작동합니다.
...
- **macOS/Windows 배포 반영** — [v0.1.38 릴리스](https://github.com/jurisupport/legal-terminal/releases/tag/v0.1.38)는 macOS arm64/x64, Windows x64 빌드와 업데이트 메타데이터를 포함합니다.
